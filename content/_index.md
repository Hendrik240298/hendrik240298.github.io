...
- **2024-Present: Reserving Actuary, HDI Global Specialty SE**
  - Working as a reserving actuary in the specialty lines of HDI Global Specialty SE.
...
- **2022-2023: Research Visitor, ENS Paris-Saclay**
  - 6 month research stay at the laboratoire de Mecanique Paris-Saclay in association with
    the IRTG 2657.
- **2021-2024: Doctoral Candidate, Leibniz Universität Hannover**
  - Doctoral candidate at the Institute of Applied Mathematics at Leibniz Universität Hannover.
- **2017-2021: Student Assistant, Technische Universität Hamburg**
  - Student assistant for several courses as well as in multiple research projects.

### Education

- **2025-Present: Actuary DAV, Deutsche Aktuarsvereinigung**
  - Participation in the DAV Education and Training Programme.
- **2021-2024: PhD (Dr. rer. nat.), Mathematics, Leibniz Universität Hannover**
  - PhD thesis: "Goal-oriented error control for space-time reduced-order modeling using
    incremental proper orthogonal decomposition"
- **2019-2021: M.Sc. Industrial Mathematics, University of Hamburg**
  - Master thesis: "Model Reduction using Incremental Decomposition Techniques to support
    Unsteady Adjoint-Based Fluid Dynamic Shape Optimization."
...
<!-- ## Interests -->
<!---->
<!-- - Actuarial automation and reserve diagnostics. -->
<!-- - Applied research in model reduction and uncertainty. -->
<!-- - Investing, Austrian economics, and long-term decision making. -->
<!-- - Writing systems that make complex work calmer. -->
<!---->
<!-- ## Writing -->
<!---->
<!-- Posts are written in markdown. -->
<!---->
<!-- - [Building calmer reserving workflows](/writing/calm-reserving-workflows/) -->
<!-- - [A field guide to model reduction in insurance](/writing/model-reduction-field-guide/) -->
<!---->
<!-- More posts soon. -->
...
- [LinkedIn](https://www.linkedin.com/in/hendrikfischer24/)
- [GitHub](https://github.com/Hendrik240298)
- [Google Scholar](https://scholar.google.de/citations?user=nfEU9yoAAAAJ&hl)
